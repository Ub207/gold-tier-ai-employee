...
def _open_browser(filepath: Path, type_key: str, dry: bool):
    """Copy post to clipboard and open LinkedIn in default browser."""
    ...
    if dry:
        print(f"\n[DRY] Would open LinkedIn and copy post to clipboard.")
        return
    ...
    print("  LinkedIn khul raha hai...")
    print("=" * 55)

    # Open LinkedIn in real browser
    webbrowser.open("https://www.linkedin.com/feed/")

    print("""
STEPS:
  1. LinkedIn feed mein "Start a post" button click karo
  2. Ctrl+V dabao (post already clipboard mein hai)
  3. "Post" button click karo

  Done! 2 minute ka kaam hai.
""")
    ...
    if filepath.exists():
        ...
        logger.info("Archived to Done/: %s", filepath.name)
    ...
    if APPROVAL_LOG.exists():
        with APPROVAL_LOG.open("a", encoding="utf-8") as lf:
            lf.write(
                ...
                f"| {filepath.name} | post_now | {type_key} | clipboard_method |\n"
            )
