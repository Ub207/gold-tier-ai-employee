...
date_header: Thu, 19 Mar 2026 18:56:38 -0700
priority: normal
status: pending
uid: 19d08f57aaa6d139
---
...
**From:** Felmon Fekadu <notifications@github.com>
**Subject:** Re: [openai/openai-agents-python] docs: clarify cancel-after-turn streaming guidance (PR #2710)
**Date:** Thu, 19 Mar 2026 18:56:38 -0700
...
Updated in d4cfc5e. I also dropped the `client-managed history` wording and narrowed this to manual `to_input_list(mode="normalized")` loops, so it no longer implies that `session=` runs should replay normalized local history.

-- 
Reply to this email directly or view it on GitHub:
https://github.com/openai/openai-agents-python/pull/2710#discussion_r2963590855
You are receiving this because you are subscribed to this thread.

Message ID: <openai/openai-agents-python/pull/2710/review/3978912750@github.com>
